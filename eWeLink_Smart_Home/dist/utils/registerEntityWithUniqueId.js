        ...
        switch (_a.label) {
            case 0:
                ...
                return [4, restRequest({
                        method: 'POST',
                        url: '/api/config/entity_registry/update/' + entityId,
                        data: {
                            unique_id: uniqueId,
                        },
                    })];
            case 1:
                _a.sent();
                logger_1.logger.info("Registered entity with unique_id: ".concat(entityId, " -> ").concat(uniqueId));
                return [3, 3];
            case 2:
                error_1 = _a.sent();
                logger_1.logger.warn("Failed to register entity unique_id for ".concat(entityId, ": ").concat(error_1));
                return [3, 3];
            case 3:
                return [2];
        }
