...
var CloudUIID173Controller = (function (_super) {
    ...
    function CloudUIID173Controller(params) {
        ...
        _this.uiid = 173;
        _this.effectList = __spreadArray([], __read(light_1.uiid173EffectList.keys()), false);
        _this.entityId = "light.".concat(params.deviceId);
        _this.params = params.params;
        _this.uiid = params.extra.uiid;
        return _this;
    }
    return CloudUIID173Controller;
}(CloudDeviceController_1.default));
CloudUIID173Controller.prototype.parseHaData2Ck = function (params) {
    console.log("parseHaData2Ck ~ 173 接收HA的参数", JSON.stringify(params));
    var state = params.state, brightness = params.brightness, brightness_pct = params.brightness_pct, effect = params.effect, color_temp_kelvin = params.color_temp_kelvin, rgb_color = params.rgb_color, color_temp = params.color_temp;
    var res = { switch: 'on' };
    if (state === 'off') {
        return {
            switch: 'off',
    ...
    if (effect) {
        var mode = light_1.uiid173EffectList.get(effect);
...
CloudUIID173Controller.prototype.updateLight = function (params) {
...
CloudUIID173Controller.prototype.updateState = function (params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            getEffect = function (mode) {
                var e_1, _a;
                var keys = light_1.uiid173EffectList.keys();
                try {
                    for (var keys_1 = __values(keys), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
                        var key = keys_1_1.value;
                        if (light_1.uiid173EffectList.get(key) === mode) {
                            return key;
                        }
                    }
                }
...
exports.default = CloudUIID173Controller;
